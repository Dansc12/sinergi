...
const EXERCISE_MUSCLE_CONFIGS: Record<string, ExerciseMuscleConfig> = {
  ...
  "incline bench press": { primaryGroup: "Push", muscleContributions: { chest: 0.5, shoulders: 0.3, triceps: 0.2 } },
  ...
  "incline dumbbell press": { primaryGroup: "Push", muscleContributions: { chest: 0.5, shoulders: 0.3, triceps: 0.2 } },
  ...
  "dip": { primaryGroup: "Push", muscleContributions: { chest: 0.4, triceps: 0.45, shoulders: 0.15 } },
  "chest dip": { primaryGroup: "Push", muscleContributions: { chest: 0.5, triceps: 0.35, shoulders: 0.15 } },
  "fly": { primaryGroup: "Push", muscleContributions: { chest: 0.9, shoulders: 0.1 } },
  "chest fly": { primaryGroup: "Push", muscleContributions: { chest: 0.9, shoulders: 0.1 } },
  "dumbbell fly": { primaryGroup: "Push", muscleContributions: { chest: 0.9, shoulders: 0.1 } },
  "cable fly": { primaryGroup: "Push", muscleContributions: { chest: 0.9, shoulders: 0.1 } },
  "pec deck": { primaryGroup: "Push", muscleContributions: { chest: 0.95, shoulders: 0.05 } },
  
  // PUSH - Shoulder focused
  "shoulder press": { primaryGroup: "Push", muscleContributions: { shoulders: 0.6, triceps: 0.3, chest: 0.1 } },
  "overhead press": { primaryGroup: "Push", muscleContributions: { shoulders: 0.6, triceps: 0.3, chest: 0.1 } },
  "military press": { primaryGroup: "Push", muscleContributions: { shoulders: 0.65, triceps: 0.3, chest: 0.05 } },
  "dumbbell shoulder press": { primaryGroup: "Push", muscleContributions: { shoulders: 0.6, triceps: 0.3, chest: 0.1 } },
  "arnold press": { primaryGroup: "Push", muscleContributions: { shoulders: 0.7, triceps: 0.2, chest: 0.1 } },
  ...
  "front raise": { primaryGroup: "Push", muscleContributions: { shoulders: 0.9, chest: 0.1 } },
  "upright row": { primaryGroup: "Push", muscleContributions: { shoulders: 0.7, triceps: 0.1, chest: 0.2 } },
  ...
  "close grip bench press": { primaryGroup: "Push", muscleContributions: { triceps: 0.55, chest: 0.35, shoulders: 0.1 } },
  "diamond push up": { primaryGroup: "Push", muscleContributions: { triceps: 0.6, chest: 0.3, shoulders: 0.1 } },
  
  // PULL - Back focused
  "pull up": { primaryGroup: "Pull", muscleContributions: { lats: 0.5, upperBack: 0.25, biceps: 0.2, rearDelts: 0.05 } },
  "pull-up": { primaryGroup: "Pull", muscleContributions: { lats: 0.5, upperBack: 0.25, biceps: 0.2, rearDelts: 0.05 } },
  "pullup": { primaryGroup: "Pull", muscleContributions: { lats: 0.5, upperBack: 0.25, biceps: 0.2, rearDelts: 0.05 } },
  "chin up": { primaryGroup: "Pull", muscleContributions: { lats: 0.4, biceps: 0.35, upperBack: 0.2, rearDelts: 0.05 } },
  "chin-up": { primaryGroup: "Pull", muscleContributions: { lats: 0.4, biceps: 0.35, upperBack: 0.2, rearDelts: 0.05 } },
  "lat pulldown": { primaryGroup: "Pull", muscleContributions: { lats: 0.6, biceps: 0.2, upperBack: 0.15, rearDelts: 0.05 } },
  "lat pull down": { primaryGroup: "Pull", muscleContributions: { lats: 0.6, biceps: 0.2, upperBack: 0.15, rearDelts: 0.05 } },
  "row": { primaryGroup: "Pull", muscleContributions: { lats: 0.35, upperBack: 0.35, biceps: 0.2, rearDelts: 0.1 } },
  "barbell row": { primaryGroup: "Pull", muscleContributions: { lats: 0.35, upperBack: 0.35, biceps: 0.2, rearDelts: 0.1 } },
  "bent over row": { primaryGroup: "Pull", muscleContributions: { lats: 0.35, upperBack: 0.35, biceps: 0.2, rearDelts: 0.1 } },
  "dumbbell row": { primaryGroup: "Pull", muscleContributions: { lats: 0.4, upperBack: 0.3, biceps: 0.2, rearDelts: 0.1 } },
  "cable row": { primaryGroup: "Pull", muscleContributions: { lats: 0.35, upperBack: 0.35, biceps: 0.2, rearDelts: 0.1 } },
  "seated row": { primaryGroup: "Pull", muscleContributions: { lats: 0.35, upperBack: 0.35, biceps: 0.2, rearDelts: 0.1 } },
  "t-bar row": { primaryGroup: "Pull", muscleContributions: { lats: 0.4, upperBack: 0.35, biceps: 0.15, rearDelts: 0.1 } },
  "deadlift": { primaryGroup: "Pull", muscleContributions: { lats: 0.2, upperBack: 0.3, hamstrings: 0.25, glutes: 0.25 } },
  "face pull": { primaryGroup: "Pull", muscleContributions: { rearDelts: 0.6, upperBack: 0.3, biceps: 0.1 } },
  ...
  "hammer curl": { primaryGroup: "Pull", muscleContributions: { biceps: 0.8, forearms: 0.2 } },
  ...
  // LEGS - Quad focused
  "squat": { primaryGroup: "Legs", muscleContributions: { quads: 0.5, glutes: 0.3, hamstrings: 0.2 } },
  "back squat": { primaryGroup: "Legs", muscleContributions: { quads: 0.5, glutes: 0.3, hamstrings: 0.2 } },
  "front squat": { primaryGroup: "Legs", muscleContributions: { quads: 0.65, glutes: 0.2, hamstrings: 0.15 } },
  "goblet squat": { primaryGroup: "Legs", muscleContributions: { quads: 0.55, glutes: 0.3, hamstrings: 0.15 } },
  "leg press": { primaryGroup: "Legs", muscleContributions: { quads: 0.6, glutes: 0.25, hamstrings: 0.15 } },
  "leg extension": { primaryGroup: "Legs", muscleContributions: { quads: 1.0 } },
  "lunge": { primaryGroup: "Legs", muscleContributions: { quads: 0.45, glutes: 0.35, hamstrings: 0.2 } },
  "walking lunge": { primaryGroup: "Legs", muscleContributions: { quads: 0.45, glutes: 0.35, hamstrings: 0.2 } },
  "split squat": { primaryGroup: "Legs", muscleContributions: { quads: 0.5, glutes: 0.35, hamstrings: 0.15 } },
  "bulgarian split squat": { primaryGroup: "Legs", muscleContributions: { quads: 0.45, glutes: 0.4, hamstrings: 0.15 } },
  "hack squat": { primaryGroup: "Legs", muscleContributions: { quads: 0.7, glutes: 0.2, hamstrings: 0.1 } },
  "step up": { primaryGroup: "Legs", muscleContributions: { quads: 0.45, glutes: 0.4, hamstrings: 0.15 } },
  
  // LEGS - Hamstring/Glute focused
  "romanian deadlift": { primaryGroup: "Legs", muscleContributions: { hamstrings: 0.5, glutes: 0.4, lowerBack: 0.1 } },
  "rdl": { primaryGroup: "Legs", muscleContributions: { hamstrings: 0.5, glutes: 0.4, lowerBack: 0.1 } },
  "stiff leg deadlift": { primaryGroup: "Legs", muscleContributions: { hamstrings: 0.55, glutes: 0.35, lowerBack: 0.1 } },
  ...
  "hip thrust": { primaryGroup: "Legs", muscleContributions: { glutes: 0.7, hamstrings: 0.3 } },
  "glute bridge": { primaryGroup: "Legs", muscleContributions: { glutes: 0.75, hamstrings: 0.25 } },
  "good morning": { primaryGroup: "Legs", muscleContributions: { hamstrings: 0.45, glutes: 0.35, lowerBack: 0.2 } },
  "hip extension": { primaryGroup: "Legs", muscleContributions: { glutes: 0.7, hamstrings: 0.3 } },
  "cable pull through": { primaryGroup: "Legs", muscleContributions: { glutes: 0.6, hamstrings: 0.4 } },
  ...
  // CORE - Abs focused
  "crunch": { primaryGroup: "Core", muscleContributions: { abs: 0.9, obliques: 0.1 } },
  "sit up": { primaryGroup: "Core", muscleContributions: { abs: 0.8, obliques: 0.2 } },
  "leg raise": { primaryGroup: "Core", muscleContributions: { abs: 0.9, obliques: 0.1 } },
  "hanging leg raise": { primaryGroup: "Core", muscleContributions: { abs: 0.85, obliques: 0.15 } },
  ...
  "plank": { primaryGroup: "Core", muscleContributions: { abs: 0.7, obliques: 0.2, lowerBack: 0.1 } },
  ...
  "back extension": { primaryGroup: "Core", muscleContributions: { lowerBack: 0.7, glutes: 0.2, hamstrings: 0.1 } },
  "hyperextension": { primaryGroup: "Core", muscleContributions: { lowerBack: 0.7, glutes: 0.2, hamstrings: 0.1 } },
  "superman": { primaryGroup: "Core", muscleContributions: { lowerBack: 0.7, glutes: 0.3 } },
  "bird dog": { primaryGroup: "Core", muscleContributions: { lowerBack: 0.5, abs: 0.3, glutes: 0.2 } },
};
