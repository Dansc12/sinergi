  ...
  return (
    <div className="min-h-screen bg-background pb-32">
      ...
      >
        ...
        {/* Workout Name & Tags Section - Only for workouts when sharing publicly */}
        {isWorkout && visibility !== "private" && (
          <div className="space-y-4 mb-6">
            {/* Workout Name */}
            <div className="space-y-2">
              <Label htmlFor="workoutTitle" className="flex items-center gap-2">
                Workout Name
